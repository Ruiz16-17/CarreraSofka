...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-07-2021 a las 10:18:55
...
INSERT INTO `tbl_juego` (`id`, `id_Pista`, `id_Podio`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 2, 3);
...
--
-- Volcado de datos para la tabla `tbl_podio`
--

INSERT INTO `tbl_podio` (`id`, `jugadorPrimero`, `jugadorSegundo`, `jugadorTercero`) VALUES
(1, 2, 6, 5),
(2, 4, 1, 2),
(3, 5, 6, 4);
